...
<html lang="en">
    <head>
        ...
        <title>Welcome Dr <?php echo $userRow['adminFirstName'];?> <?php echo $userRow['adminLastName'];?></title>
        <!-- Bootstrap Core CSS -->
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="admindashboard.php">Welcome Dr <?php echo $userRow['adminFirstName'];?> <?php echo $userRow['adminLastName'];?></a>
                </div>
                <!-- Top Menu Items -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-calendar"></i> user List
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            while ($userRow=mysqli_fetch_array($result)) {
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td>" . $userRow['userMaritialStatus'] . "</td>";
                                    echo "<td>" . $userRow['userDOB'] . "</td>";
                                    echo "<td>" . $userRow['userAddress'] . "</td>";
                                    echo "<form method='POST'>";
                                    echo "<td class='text-center'><a href='#' id='".$userRow['icuser']."' class='delete'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>
                            </td>";
