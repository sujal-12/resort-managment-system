                    ...
                    <div class="panel panel-primary filterable">
                       ...
                       <div class="panel-heading">
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    <th><input type="text" class="form-control" placeholder="user Ic" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Name" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Contact No." disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Email" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Date" disabled></th>
                                    <th><input type="text" class="form-control" placeholder="Slot" disabled></th>
                            ...
                            while ($booking=mysqli_fetch_array($res)) {
                                ...
                                echo "<tr class='$status'>";
                                    echo "<td>" . $booking['userIc'] . "</td>";
                                    echo "<td>" . $booking['userLastName'] . "</td>";
                                    echo "<td>" . $booking['userPhone'] . "</td>";
                                    echo "<td>" . $booking['userEmail'] . "</td>";
                                    echo "<td>" . $booking['scheduleDate'] . "</td>";
                                    echo "<td>" . $booking['slot_name'] . "</td>";
                                    echo "<td>" . $booking['scheduleprice'] . "</td>";
                                    echo "<td><span class='glyphicon glyphicon-".$icon."' aria-hidden='true'></span>".' '."". $booking['status'] . "</td>";
                                    echo "<form method='POST'>";
                                    echo "<td class='text-center'><input type='checkbox' name='enable' id='enable' value='".$booking['appId']."' onclick='chkit(".$booking['appId'].",this.checked);' ".$checked."></td>";
                                    echo "<td class='text-center'><a href='#' id='".$booking['appId']."' class='delete'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>
                            </td>";
